  ...
  <div id="header">
    <div class="nav-global">
      <div class="container">
            ...
            <div class="nav-user-wrapper">
              <div class="nav-user-list">
                ...
                <ul>
                  ...
                  <!-- <li class="support"><a href="javasript:;">售后服务</a></li> -->
        ...
        <ul class="nav-list">
          <li class=""><a href="javascript:;">在线商城</a></li>
          <li class=""><a href="javascript:;">坚果 Pro</a></li>
          <li class=""><a href="javascript:;">Smartisan M1 / M1L</a></li>
          <li class=""><a href="javascript:;">Smartisan OS</a></li>
          <li class=""><a href="javascript:;">欢喜云</a></li>
          <li class=""><a href="javascript:;">应用下载</a></li>
          <li class=""><a href="javascript:;">官方论坛</a></li>
        </ul>
      </div>
    </div>
    <div class="nav-sub">
